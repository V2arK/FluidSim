...
For implementing this, I borrowed the random generator from `cs488.h`, defined the kernel functions for the SPH computation (Cubic Spline), augment the `Particle` to contain all necessary information for later computation, and augment `ParticleSystem` class for handling everything from adding water block, and sorting water particles. So the fundation for the fluid simulation is laid, now what's missing is the actual updating of particles using SPH.

![image](screenshots/sc4.png)

```diff
diff --git a/src/main.cpp b/src/main.cpp
index 89ccba3..d88a22c 100644
--- a/src/main.cpp
+++ b/src/main.cpp
@@ -4,6 +4,9 @@
 #include <string>
